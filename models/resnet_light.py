...
class PreAct_ResNet_Cifar(nn.Module):
    def __init__(self, block, layers, num_classes=10, noise_coef=None):
        ...
        self.layer1 = self._make_layer(block, 4, layers[0], noise_coef=noise_coef)
        self.layer2 = self._make_layer(block, 8, layers[1], stride=2, noise_coef=noise_coef)
        self.layer3 = self._make_layer(block, 16, layers[2], stride=2, noise_coef=noise_coef)
        self.bn = nn.BatchNorm2d(16*block.expansion)
        self.relu = nn.ReLU(inplace=True)
